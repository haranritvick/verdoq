...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-text-primary relative overflow-hidden">
      ...
      <div className="glow-orb bg-primary w-[300px] h-[300px] md:w-[500px] md:h-[500px] top-[-50px] left-[-100px] opacity-20" />
      <div className="glow-orb bg-blue-500 w-[350px] h-[350px] md:w-[600px] md:h-[600px] top-[15%] right-[-150px] opacity-15" />
      <div className="glow-orb bg-purple-500 w-[250px] h-[250px] md:w-[400px] md:h-[400px] bottom-[-50px] left-[15%] opacity-15" />
      ...
      <main className="relative z-10 px-6 pt-24 pb-20 md:pb-32 max-w-7xl mx-auto flex flex-col items-center text-center">
        <motion.div
        ...
        >
          ...
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold font-heading leading-tight md:leading-[1.1] mb-8">
            The verdict on <br className="hidden sm:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/40">
              every document.
            </span>
          </h1>

          <p className="text-base sm:text-lg md:text-xl text-text-secondary max-w-2xl mx-auto mb-10 leading-relaxed font-light px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto px-6">
            <button onClick={handleLogin} className="btn-primary text-base sm:text-lg px-8 py-4 w-full sm:w-auto">
              <Shield className="w-5 h-5 mr-1.5 sm:mr-2" />
              Get Started for Free
              <ArrowRight className="w-5 h-5 ml-1.5 sm:ml-2" />
            </button>
        ...
        <motion.div 
          className="relative mt-16 md:mt-24 w-full max-w-5xl mx-auto hidden sm:block"
      ...
      {/* Bento Grid Features */}
      <section className="relative z-10 px-6 py-16 md:py-32 bg-black/40 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 md:mb-20">
            <h2 className="text-3xl md:text-5xl font-heading font-bold mb-4">Decode complexity instantly.</h2>
            <p className="text-text-secondary text-base sm:text-lg max-w-2xl mx-auto px-4">Upload any dense legal document and our models break it down into actionable insights.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:auto-rows-[250px]">
            <div className="glass-card p-8 md:col-span-2 flex flex-col justify-between group hover:border-primary/30 transition-colors">
              ...
              <div className="h-2 w-full bg-white/5 rounded-full mt-8 md:mt-4 overflow-hidden">
                <div className="h-full bg-primary w-2/3" />
              </div>
            </div>

            <div className="glass-card p-8 flex flex-col min-h-[250px] justify-between group hover:border-danger/30 transition-colors">
              <div>
            ...
            <div className="glass-card p-8 flex flex-col min-h-[250px] justify-between group hover:border-blue-500/30 transition-colors">
              <div>
      ...
      {/* Footer CTA */}
      <section className="relative z-10 px-6 py-20 md:py-32 border-t border-white/5 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
          <h2 className="text-4xl md:text-7xl font-heading font-bold mb-8 px-4">Stop signing things blindly.</h2>
          <button onClick={handleLogin} className="btn-primary text-lg sm:text-xl px-12 py-5 mx-auto w-full sm:w-auto">
            Try Verdoq Now
      ...
      {/* Footer Minimal */}
      <footer className="relative z-10 px-6 py-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-sm text-text-secondary max-w-7xl mx-auto gap-4">
        <div className="flex items-center gap-2">
          <Scale className="w-4 h-4 text-primary" />
          <span className="font-heading font-semibold text-text-primary">Verdoq</span>
        </div>
        <p className="text-center md:text-right">© {new Date().getFullYear()} Verdoq AI. All rights reserved.</p>
      </footer>
    </div>
  );
}
